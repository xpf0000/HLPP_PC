    ...
    E.plugin(function () {
        ...
        editor.xhrUploadImg = function (opt) {
            ...
            function timeoutCallback() {
                ...
                timeoutfn && timeoutfn.call(editor, upxhr);

                // 隐藏进度条
                editor.hideUploadProgress();
            }

            upxhr.onload = function (data) {
                if (timeoutId) {
                    clearTimeout(timeoutId);
                }
                ...
                loadfn && loadfn.call(editor, data, upxhr);

                // 隐藏进度条
                editor.hideUploadProgress();
            };
            
            upxhr.onerror = function (err) {
                if (timeoutId) {
                    clearTimeout(timeoutId);
                }
                ...
                errorfn && errorfn.call(editor, upxhr);

                // 隐藏进度条
                editor.hideUploadProgress();
            };
            // xhr.onprogress = updateProgress;
            upxhr.upload.onprogress = updateProgress;
...
// 			xhr.setRequestHeader("Origin", "*");
            ...
            $.each(headers, function (key, value) {
                upxhr.setRequestHeader(key, value);
            });

            // 跨域上传时，传cookie
            upxhr.withCredentials = true;
